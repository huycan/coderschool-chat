# Homework 2 - *Happy Chatty*

**Happy Chatty** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
Only bcrypt 3.1.11 and above works on my Windows 10.

Very good guide on self-referential modeling [StackOverflow](http://stackoverflow.com/questions/2168442/many-to-many-relationship-with-the-same-model-in-rails).
